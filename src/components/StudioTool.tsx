    ...
    >
      ...
      {tab === 'analytics' && (
        <>
          ...
          <ToolSection title="Gallery lineage clusters">
            <p className="text-sm text-zinc-400">
              Parent outputs with upscale, refine, or variation derivatives. Open Gallery to act on
              a cluster.
            </p>
      ...
      {tab === 'projects' && (
        <ToolSection title="Prompt projects">
          <p className="text-sm text-zinc-400">
            Group history and gallery jobs under named campaigns. Set an active project to filter
            Studio history.
          </p>
      ...
      {tab === 'presets' && (
        <ToolSection>
          ...
          <div className="space-y-3 border-t border-zinc-800 pt-4">
            ...
            <p className="text-xs text-zinc-500">
              Export/import — or save to a browser-local list — reusable character sheets: locks,
              hints, pinned descriptor, and a portable IP-Adapter reference (image/strength/model —
              see Settings → ComfyUI). Enable LoRAs from the LoRA stack on each tool.
            </p>
            <input
            ...
            <>
              <ToolMetaPanel>
                <p className="type-body">
                  Compare two saved prompts word-by-word. Pick entries from history or use the Diff
                  A / Diff B buttons on history cards.
                </p>
              </ToolMetaPanel>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
