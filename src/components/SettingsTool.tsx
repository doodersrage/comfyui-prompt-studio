...
import { formatModelControlNetMap, parseModelControlNetMap } from '@/lib/model-controlnet-map';
import { formatModelLoraMap, parseModelLoraMap } from '@/lib/model-lora-map';
import {
...
const SettingsBundlePanel = dynamic(() => import('@/components/settings/SettingsBundlePanel'), {
...
const LoraTrainPanel = dynamic(() => import('@/components/settings/LoraTrainPanel'), {
  loading: () => <ToolPageSkeleton label="Loading LoRA train" />,
});
const ComfyModelAssetsPanel = dynamic(() => import('@/components/settings/ComfyModelAssetsPanel'), {
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="min-w-0 space-y-1">
                      ...
                      <p className="type-caption text-[var(--text-secondary)]">
                        One click for new installs: enable system workflows, merge suggested loader
                        maps, adapt from ComfyUI inventory when reachable, and refresh health.
                      </p>
                    </div>
                    <Button
                      size="sm"
            ...
            <>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-1">
                    ...
                    <select
                      id="inference-engine"
                      value={
                        sharedSettings.inferenceEngine === 'diffusers' ? 'diffusers' : 'comfyui'
                      }
                      onChange={event =>
                        updateSharedSettings({
                          inferenceEngine:
                ...
                <label className="mb-3 flex cursor-pointer items-start gap-3">
                  ...
                  <span className="space-y-1">
                    ...
                    <span className="block text-xs text-zinc-500">
                      ...
                      workflow picker while enabled. Enabling scans ComfyUI inventory and adapts
                ...
                {sharedSettings.useSystemWorkflows === true ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      onClick={() => {
                        const suggested =
                          suggestWorkflowDefaultsByCategory(loadComfyWorkflowFiles());
              ...
              <ToolSection id="settings-comfyui-ipadapter" title="IP-Adapter identity reference">
                <p className="text-sm text-zinc-400">
                  ...
                  instead. You can also import a BYO InstantID / PuLID scaffold from the Workflow
                  library.
                </p>

                <div className="space-y-2">
                  <FieldLabel htmlFor="settings-ipadapter-image">
            ...
            <>
              ...
              <ToolSection title="Local data">
                <p className="text-sm text-zinc-400">
                  ...
                  export above when you only need prefs.
                </p>
                {backupReminder ? (
