...
export function recordCatalogBiasFromPrompt(prompt: string, rating: number | undefined): void {
...
export function sortCatalogByRatingBias<T>(items: T[], toLabel: (item: T) => string): T[] {
  return [...items].sort(
