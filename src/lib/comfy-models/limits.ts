...
export const PROFILE_LIMITS: Record<PromptProfileId, Record<DetailLevel, PromptLimits>> = {
...
export function getProfileLimits(profile: PromptProfileId, detail: DetailLevel): PromptLimits {
